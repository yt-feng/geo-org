...
<body>$header<main id="top"><section class="hero wrap"><div class="eyebrow">Brand-first GEO</div><h1>$home_title</h1><p class="lead">$home_lead</p><div class="actions"><a class="btn primary" href="brand-audit/">$home_primary</a><a class="btn" href="contact/#inquiry">$cta_link</a><a class="btn" href="mailto:$email?subject=Eco%20GEO%20AIBE%20Consultation">$home_secondary</a></div></section>
