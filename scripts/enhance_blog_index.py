...
<body>
  ...
  <footer class="footer site-footer"><div class="wrap">© 2026 Eco GEO · Brand-first GEO · <a href="../index.html">首页</a> · <a href="./">前沿观点</a> · <a href="mailto:yt.feng@foxmail.com">yt.feng@foxmail.com</a></div></footer>
  <script>
    const PAGE_SIZE = 24;
    const IMAGE_POOL = [
